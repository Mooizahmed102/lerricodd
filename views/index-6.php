...
<html lang="zxx">
  ...
  <body>
    <div class="section-wrapper">
          ...
          <div class="row gx-5">
            ...
            >
              <div class="booksv1__contnet">
                ...
                <h3 class="display-6 m-30px-b">2022 best selling books</h3>
      ...
      <!-- ========== Events section end ========== -->
      <!-- ========== Booksv2 start ========== -->
      <section class="chapter__preview2 section-padding">
        <div class="container">
          <div class="row">
            <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
              <div class="section-title-center text-center">
              ...
              >
                <ul class="footer__menu">
                  ...
                  <li
                    ...
                    data-aos-delay="450"
                  >
                    <a href="#testimonial" class="smooth">Testimonials</a>
                  </li>
                  <li
                    data-aos="fade-up"
                    data-aos-duration="1000"
