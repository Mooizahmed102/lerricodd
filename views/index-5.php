...
<html lang="zxx">
  ...
  <body>
    <div class="section-wrapper">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
              <div class="hero__content position-relative">
                ...
                <p
                  ...
                  data-aos-delay="700"
                >
                  My 13th book 'Things I never said' has been published. Fill
                  the form below and get free chapter now.
                </p>
                <form
              ...
              <div class="hero__author text-center">
                <div class="hero__author--inner hero__author--inner2">
                  <div
                    ...
                    style="background-image: url(assets/images/writer-2.png)"
                  ></div>
          ...
          <div class="row gx-5">
            ...
            >
              <div class="booksv1__contnet">
                ...
                <h3 class="display-6 m-30px-b">Books released in 2022</h3>
          ...
          <div class="row">
            ...
            >
              <div class="books__book h-100 translateEffect1">
                <img
                  ...
                  alt="Book 3"
                />
                <p class="books__book__subtitle">Basic Programming</p>
                <h3 class="books__book__title">Think & grow rich</h3>
            ...
            >
              <div class="books__book h-100 translateEffect1">
                ...
                />
                <p class="books__book__subtitle">Basic Programming</p>
                <h3 class="books__book__title">Rich dad, poor dad</h3>
                <div class="d-flex justify-content-between">
                  <span>$149</span>
                  <ul>
                    <li><i class="icofont-star"></i></li>
            ...
            <div
              class="col-md-6 col-lg-3 mb-4 mb-md-0"
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-delay="400"
            >
              <div class="books__book h-100 translateEffect1">
                <img
                  class="img-fluid"
                  src="assets/images/book5.png"
                  alt="Book 5"
                />
                <p class="books__book__subtitle">Basic Programming</p>
                <h3 class="books__book__title">Eat that frog</h3>
                <div class="d-flex justify-content-between">
                  <span>$199</span>
                  <ul>
                    <li><i class="icofont-star"></i></li>
            ...
            >
              <div class="books__book h-100 translateEffect1">
                ...
                />
                <p class="books__book__subtitle">Basic Programming</p>
                <h3 class="books__book__title">Design Patterns</h3>
                <div class="d-flex justify-content-between">
                  <span>$59</span>
                  <ul>
                    <li><i class="icofont-star"></i></li>
      ...
      <section id="achievement" class="section-padding achievement">
        <div class="container">
          <div class="row">
            <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
              <div class="section-title-center text-center">
            ...
            >
              <div class="card h-100 translateEffect1">
                <div class="card-body">
                  ...
                  <h4 class="mb-3">Discussion On Horror Thriller</h4>
                  <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Labore quas volupta tibus porro quod quo blanditiis sint
                    ipsam! Repellendus, voluptatibus soluta!
                  </p>
                </div>
                <a href="single-event.html" class="link"
      ...
      <section class="section-padding testimonial" id="testimonial">
        <div class="container">
          <div class="row">
            <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
              <div class="section-title-center text-center">
                ...
                <div class="blog__single-post__body">
                  ...
                  <ul class="blog-metainfo">
                    <li>
                      ...
                      ><a href="/food-delivery2">May 22, 2022</a>
                    </li>
                    <li>
          ...
          <div class="row">
            <div class="col-md-6 mb-4 mb-lg-0 ctav4__content">
              ...
              <h3
                ...
                data-aos-delay="200"
              >
                to see how my readers love my books.
              </h3>
              <p
                data-aos="fade-up"
                data-aos-duration="1000"
                data-aos-delay="250"
              >
                Still have any doubts? Check a free copy to get an idea.
              </p>
              <a
                href="#"
