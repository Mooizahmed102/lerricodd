...
<html lang="zxx">
  ...
  <body>
    <div class="section-wrapper">
            ...
            <div class="col-md-7 col-lg-6 m-0px-b md-m-40px-b">
              <div class="hero__content position-relative">
                ...
                <div
                  ...
                  data-aos-delay="950"
                >
                  <a href="#pricing" class="smooth button button__primary me-3">
                    <span>Buy now</span>
                  </a>
                  <a
      ...
      <section id="chapters" class="section-padding chapter bg-one">
        <div class="container">
          <div class="row">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
              <div
                class="chapter__item h-100 translateEffect1"
                data-aos="fade-up"
                data-aos-duration="1000"
                data-aos-delay="650"
              >
            ...
            <div class="chapter__preview2-content">
              <div class="chapter__preview2-container">
                <div
                  class="panel active"
                  style="
                    background-image: url('assets/images/chapter-preview/6.png');
                  "
                >
                  <h3>Chapter 1</h3>
                </div>
                <div
                  class="panel"
                  style="
                    background-image: url('assets/images/chapter-preview/7.png');
                  "
                >
                  <h3>Chapter 2</h3>
                </div>
                <div
                  class="panel"
                  style="
                    background-image: url('assets/images/chapter-preview/8.png');
                  "
                >
                  <h3>Chapter 3</h3>
                </div>
                <div
                  class="panel"
                  style="
                    background-image: url('assets/images/chapter-preview/9.png');
                  "
                >
                  <h3>Chapter 4</h3>
                </div>
                <div
                  class="panel"
                  style="
                    background-image: url('assets/images/chapter-preview/10.png');
                  "
                >
                  <h3>Chapter 5</h3>
                </div>
          ...
          <div class="row">
            ...
            >
              <div class="author__content">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Commodi nam eveniet veritatis aliquid harum temporibus et
                  pariatur. Incidunt, labore voluptatum minima tenetur,
                  consequatur odit sapiente blanditiis perferendis corrupti non
                  quisquam?
                </p>
                <ul class="author__content__desc m-30px-b">
                  <li><i class="icofont-check"></i>Achieved 10+ awarded</li>
                  <li>
                    <i class="icofont-check"></i>Very passionate about writting
                  </li>
                  <li>
                    <i class="icofont-check"></i>Most Popular writter in the
                    year
                  </li>
                  <li><i class="icofont-check"></i>17+ Books written</li>
                </ul>
      ...
      <section class="section-padding counters">
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12">
              <ul
                class="counters__stats m-0 p-0 d-flex flex-wrap align-items-center justify-content-center"
              >
                <li
                  data-aos="fade-up"
                  data-aos-duration="1000"
      ...
      <!-- ========== CTA v5 section end ========== -->
      <!-- ========== Events section end ========== -->
      <section id="events" class="section-padding event">
        <div class="container">
          <div class="row">
            <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
              <div class="section-title-center text-center">
                ...
                <div class="events__single-event__body">
                  ...
                  <div class="events__single-event__meta">
                    <div class="d-flex align-items-center gap-1">
                      ...
                      <a href="#">3 June, 2021</a>
                    </div>
                    <div class="d-flex align-items-center gap-1">
                      <i class="icofont-location-pin"></i> <a href="#">Milan</a>
                    </div>
                  </div>
                </div>
              </article>
      ...
      <section
        id="reviews"
        class="section-padding testimonial testimonialv2 bg-one"
      >
        <div class="container">
          <div class="row">
      ...
      <section id="ctav3" class="ctav3 bg-one section-padding">
      ...
      <section id="contact" class="p-80px-tb bg-white">
        <div class="container">
          ...
          <div class="row">
            <!-- Contact form start -->
            <div
              class="col-lg-8 col-md-6 md-m-25px-b"
              data-aos="fade-right"
              data-aos-duration="1000"
              data-aos-delay="200"
            >
                ...
                <div class="footer___topV2__contact">
                  ...
                  <ul class="info">
                    <li>
                      ...
                      ><a href="#">San Fransisco CA 94107,US</a>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      ><a tel="+123 345123 556">+123 345123 556</a>
                    </li>
                  </ul>
                  <ul class="social-icon">
                    <li>
