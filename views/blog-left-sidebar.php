...
<html lang="zxx">
  ...
  <body>
    ...
    <!-- ========== All blogs hero end ========== -->
    <!-- ========== Details Right Sidebar start ========== -->
    <section class="section-padding all-blog2">
      <div class="container">
        <div class="row">
          <div
            class="col-lg-8 mb-4 mb-md-0 order-lg-2"
            data-aos="fade-right"
            data-aos-duration="1000"
            data-aos-delay="200"
          >
          ...
          <div class="single-blog__category d-xl-flex">
              <div class="tags gap-1 mb-3 mb-xl-0 d-sm-flex">
                <h5 class="mb-2 mb-sm-0">Tags:</h5>
                <ul>
                  <li><a href="#">Marketing</a></li>
                  <li><a href="#">Digital Marketing</a></li>
                </ul>
              </div>
              <div class="category gap-1 mb-3 mb-xl-0 d-sm-flex">
                <h5 class="mb-2 mb-sm-0">Category:</h5>
                <ul>
                  <li><a href="#">Digital Marketing</a></li>
                  <li><a href="#">Marketing</a></li>
                </ul>
          ...
          <div class="single-blog__comment">
            ...
            <div class="single-blog__comment__form bg-one" id="cmt-form">
              <div class="m-25px-b">
          ...
          >
            <div class="all-blog2__sidebar">
              ...
              <div class="all-blog2__sidebar__archive item-border">
                ...
                <ul>
                  <li><a href="#">December 2019</a>&nbsp;(1)</li>
                  <li><a href="#">January 2019</a>&nbsp;(7)</li>
                  <li><a href="#">October 2018</a>&nbsp;(1)</li>
                  <li><a href="#">January 2018</a>&nbsp;(1)</li>
                  <li><a href="#">October 2017</a>&nbsp;(1)</li>
                  <li><a href="#">October 2016</a>&nbsp;(10)</li>
                </ul>
              </div>
            ...
            >
              <ul class="footer__menu">
                ...
                <li
                  ...
                  data-aos-delay="300"
                >
                  <a href="#left-sidebar" class="smooth">Blog</a>
                </li>
              </ul>
            </div>
            <div
